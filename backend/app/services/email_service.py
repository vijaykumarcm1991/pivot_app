    ...
    <tr>
      <td align="center">
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="640" style="max-width:640px;background-color:#ffffff;border:1px solid #e0e0e0;border-radius:6px;overflow:hidden;">
          ...
          {grand_total_html}
          <tr>
            <td style="padding:16px 24px;font-size:14px;line-height:1.55;color:#222;border-top:1px solid #eee;">
              The detailed drill-down report is attached.
            </td>
          </tr>
          <tr>
            <td style="padding:16px 24px;background-color:#fafafa;font-size:12px;line-height:1.5;color:#666;border-top:1px solid #e0e0e0;">
